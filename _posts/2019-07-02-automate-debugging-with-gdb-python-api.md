...
In this series of posts we will explore some of the GDB Python APIs and how they
can be used.
...
We can take it a step farther by
...
We then need to register the custom pretty print detector with gdb by appending
