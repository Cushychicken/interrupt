...
Throughout the [Zero to main() series]({% tag_url zero-to-main %}) of posts, we
demystify what happens between when power is applied and your main function is
called. In the process, we'll learn how to bootstrap a C environment, implement
a bootloader, relocate code, and more!
...
2. If our program relies on libc, we must initialize it  
   _EDIT: Post written!_ - [From Zero to main(): Bootstrapping libc with
...
_EDIT: Post written!_ - [From Zero to main(): Demystifying Firmware Linker
